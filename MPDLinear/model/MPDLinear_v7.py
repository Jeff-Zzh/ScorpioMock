...
'''
MPDLinear_v7: 包含module1和module4
'''
...
class MPDLinear_v7(nn.Module):
    ...
    def __init__(self, configs):
        super(MPDLinear_v7, self).__init__()
    ...
    def forward(self, x):
        ...
        forward_output = seasonal_output + trend_output + periodic_output + res_trend_season_periodic_output + nonlinear_trend_output
