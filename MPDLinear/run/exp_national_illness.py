...
from MPDLinear.data_process.data_processor import preprocessing_data, load_data, clean_weather_and_save, \
    ...
    feature_engineering_for_national_illness_and_save
...
# 定义不同的 seq_len 值列表(间隔为week)
seq_len_list = [1, 2, 4, 6, 8, 12, 24, 48, 96, 192]

# 配置
config = ModelConfig() # 初始化模型参数配置
dataset_path = '../datasets/9_LTSF_dataset/ori/national_illness.csv'
...
expand_time_feature_dataset = feature_engineering_for_national_illness_and_save(ori_dataset)
