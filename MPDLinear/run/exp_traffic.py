...
from MPDLinear.data_process.data_processor import preprocessing_data, load_data, clean_weather_and_save, \
    ...
    feature_engineering_for_traffic_and_save
...
dataset_path = '../datasets/9_LTSF_dataset/ori/traffic.csv'
...
expand_time_feature_dataset = feature_engineering_for_traffic_and_save(ori_dataset)
...
selected_features = dataset_exp.columns[:869] # 选前869列作为feature
...
config.enc_in = len(selected_features) # 特征列数 = 通道数 = 869
