...
from MPDLinear.data_process.data_processor import preprocessing_data, load_data, clean_weather_and_save, \
    ...
    feature_engineering_for_etth1_and_save, feature_engineering_for_ettm1_and_save
...
dataset_path = '../datasets/9_LTSF_dataset/ori/ETTm1.csv'
...
expand_time_feature_dataset = feature_engineering_for_ettm1_and_save(ori_dataset)
...
# 保存标准化后的数据到 CSV 文件
standardized_data.to_csv('../datasets/9_LTSF_dataset/processed/standardized/ETTm1_processed_standardized.csv', index=False)
...
# 保存归一化后的数据到 CSV 文件
normalized_data.to_csv('../datasets/9_LTSF_dataset/processed/normalized/ETTm1_processed_normalized.csv', index=False)
